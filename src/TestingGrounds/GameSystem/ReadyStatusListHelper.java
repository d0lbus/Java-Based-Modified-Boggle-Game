...
/**
* TestingGrounds/GameSystem/ReadyStatusListHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from GameSystem.idl
* Thursday, May 16, 2024 10:14:50 PM SGT
*/

abstract public class ReadyStatusListHelper
{
  private static String  _id = "IDL:TestingGrounds/GameSystem/ReadyStatusList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (TestingGrounds.GameSystem.ReadyStatusListHelper.id (), "ReadyStatusList", __typeCode);
    }
    return __typeCode;
  }
