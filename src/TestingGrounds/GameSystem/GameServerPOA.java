 ...
 implements TestingGrounds.GameSystem.GameServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("leaveGame", new java.lang.Integer (7));
    _methods.put ("leaveLobby", new java.lang.Integer (8));
    _methods.put ("getLetters", new java.lang.Integer (9));
    _methods.put ("updateSecondsPerWaiting", new java.lang.Integer (10));
    _methods.put ("ping", new java.lang.Integer (11));
    _methods.put ("isServerConnected", new java.lang.Integer (12));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // TestingGrounds/GameSystem/GameServer/leaveGame
       {
         String sessionToken = in.read_string ();
         String gameId = in.read_string ();
           try {
       ...
       case 8:  // TestingGrounds/GameSystem/GameServer/leaveLobby
       {
         String sessionToken = in.read_string ();
         String gameId = in.read_string ();
           try {
       ...
       case 9:  // TestingGrounds/GameSystem/GameServer/getLetters
       {
         String sessionToken = in.read_string ();
         String gameId = in.read_string ();
         String $result = null;
       ...
       case 10:  // TestingGrounds/GameSystem/GameServer/updateSecondsPerWaiting
       {
       ...
       case 11:  // TestingGrounds/GameSystem/GameServer/ping
       {
         boolean $result = false;
         $result = this.ping ();
         out = $rh.createReply();
       ...
       case 12:  // TestingGrounds/GameSystem/GameServer/isServerConnected
       {
         try {
           boolean $result = false;
