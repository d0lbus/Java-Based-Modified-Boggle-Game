    ...
    switch (__method.intValue ())
    {
       ...
       case 3:  // TestingGrounds/GameSystem/GameServer/joinRandomGame
       {
         try {
           ...
           out = $rh.createReply();
           out.write_string ($result);
         } catch (NoWaitingGames | SQLException $ex) {
           out = $rh.createExceptionReply ();
           TestingGrounds.GameSystem.NoWaitingGamesHelper.write (out, (NoWaitingGames) $ex);
         }
         break;
       }
       ...
       case 6:  // TestingGrounds/GameSystem/GameServer/submitWord
       {
         try {
           ...
           out = $rh.createReply();
         } catch (InvalidWord | SQLException $ex) {
           out = $rh.createExceptionReply ();
           TestingGrounds.GameSystem.InvalidWordHelper.write (out, (InvalidWord) $ex);
         }
         break;
       }
