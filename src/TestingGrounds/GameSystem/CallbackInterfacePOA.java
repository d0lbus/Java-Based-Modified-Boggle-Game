 ...
 implements TestingGrounds.GameSystem.CallbackInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("displayTie", new java.lang.Integer (9));
    _methods.put ("ReadyStateException", new java.lang.Integer (10));
    _methods.put ("wordHasBeenGuessed", new java.lang.Integer (11));
    _methods.put ("wordIsValid", new java.lang.Integer (12));
    _methods.put ("wordIsInvalid", new java.lang.Integer (13));
    _methods.put ("startRoundDelayTimer", new java.lang.Integer (14));
    _methods.put ("updateWaitingTimeLabel", new java.lang.Integer (15));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 7:  // TestingGrounds.GameSystem/CallbackInterface/displayRoundWinner
       {
         ...
         this.displayRoundWinner (winnerName);
         out = $rh.createReply();
         break;
       }
       ...
       case 9:  // TestingGrounds.GameSystem/CallbackInterface/displayTie
       {
         this.displayTie ();
         out = $rh.createReply();
         break;
       ...
       case 10:  // TestingGrounds.GameSystem/CallbackInterface/ReadyStateException
       {
       ...
       case 11:  // TestingGrounds.GameSystem/CallbackInterface/wordHasBeenGuessed
       {
         String word = in.read_string ();
       ...
       case 12:  // TestingGrounds.GameSystem/CallbackInterface/wordIsValid
       {
         String word = in.read_string ();
       ...
       case 13:  // TestingGrounds.GameSystem/CallbackInterface/wordIsInvalid
       {
         String word = in.read_string ();
       ...
       case 14:  // TestingGrounds.GameSystem/CallbackInterface/startRoundDelayTimer
       {
       ...
       case 15:  // TestingGrounds.GameSystem/CallbackInterface/updateWaitingTimeLabel
       {
