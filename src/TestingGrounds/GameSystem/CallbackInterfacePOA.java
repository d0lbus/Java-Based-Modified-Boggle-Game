 ...
 implements TestingGrounds.GameSystem.CallbackInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("startRoundTimer", new java.lang.Integer (4));
    _methods.put ("broadcastGuessedWord", new java.lang.Integer (5));
    _methods.put ("displayRoundWinner", new java.lang.Integer (6));
    _methods.put ("displayOverallWinner", new java.lang.Integer (7));
    _methods.put ("displayTie", new java.lang.Integer (8));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // TestingGrounds.GameSystem/CallbackInterface/startRoundTimer
       {
         int durationSeconds = in.read_long ();
       ...
       case 5:  // TestingGrounds.GameSystem/CallbackInterface/broadcastGuessedWord
       {
         TestingGrounds.GameSystem.PlayerInfo playerData[] = TestingGrounds.GameSystem.PlayerInfoListHelper.read (in);
       ...
       case 6:  // TestingGrounds.GameSystem/CallbackInterface/displayRoundWinner
       {
       ...
       case 7:  // TestingGrounds.GameSystem/CallbackInterface/displayOverallWinner
       {
         String winnerName = in.read_string ();
       ...
       case 8:  // TestingGrounds.GameSystem/CallbackInterface/displayTie
       {
         this.displayTie ();
         out = $rh.createReply();
         break;
