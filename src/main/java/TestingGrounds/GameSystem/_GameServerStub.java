...
/**
* GameSystem/_GameServerStub.java .
...
public class _GameServerStub extends org.omg.CORBA.portable.ObjectImpl implements GameServer
{
  ...
  public boolean login (String username, String password, org.omg.CORBA.StringHolder sessionToken)
  {
            ...
            try {
                ...
                return login (username, password, sessionToken        );
            } finally {
                _releaseReply ($in);
            }
  } // login
  ...
  public String hostGame (String sessionToken, CallbackInterface gci)
  {
            ...
            try {
                ...
                $out.write_string (sessionToken);
                CallbackInterfaceHelper.write ($out, gci);
                $in = _invoke ($out);
                ...
                return hostGame (sessionToken, gci        );
            } finally {
                _releaseReply ($in);
            }
  } // hostGame
  ...
  public boolean joinRandomGame (String sessionToken, CallbackInterface gci)
  {
            ...
            try {
                ...
                return joinRandomGame (sessionToken, gci        );
            } finally {
                _releaseReply ($in);
            }
  } // joinRandomGame
