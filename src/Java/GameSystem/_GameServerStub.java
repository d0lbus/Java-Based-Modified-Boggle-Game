...
public class _GameServerStub extends org.omg.CORBA.portable.ObjectImpl implements Java.GameSystem.GameServer
{

  public boolean login (String username, String password, org.omg.CORBA.StringHolder sessionToken, Java.GameSystem.CallbackInterface cbi) throws Java.GameSystem.InvalidCredentials, Java.GameSystem.AlreadyLoggedIn
  {
            ...
            try {
                ...
                Java.GameSystem.CallbackInterfaceHelper.write ($out, cbi);
                $in = _invoke ($out);
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/InvalidCredentials:1.0"))
                    throw Java.GameSystem.InvalidCredentialsHelper.read ($in);
                else if (_id.equals ("IDL:TestingGrounds/GameSystem/AlreadyLoggedIn:1.0"))
                    throw Java.GameSystem.AlreadyLoggedInHelper.read ($in);
                else
  ...
  public boolean adminLogin (String username, String password, org.omg.CORBA.StringHolder sessionToken, Java.GameSystem.CallbackInterface cbi) throws Java.GameSystem.InvalidCredentials, Java.GameSystem.AlreadyLoggedIn
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String hostGame (String sessionToken, Java.GameSystem.CallbackInterface cbi)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String joinRandomGame (String sessionToken, Java.GameSystem.CallbackInterface cbi) throws Java.GameSystem.NoWaitingGames
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/NoWaitingGames:1.0"))
                    throw Java.GameSystem.NoWaitingGamesHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public String joinGame (String sessionToken, String gameId) throws Java.GameSystem.InvalidGameCode, Java.GameSystem.GameAlreadyActive
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/InvalidGameCode:1.0"))
                    throw Java.GameSystem.InvalidGameCodeHelper.read ($in);
                else if (_id.equals ("IDL:TestingGrounds/GameSystem/GameAlreadyActive:1.0"))
                    throw Java.GameSystem.GameAlreadyActiveHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public boolean startGame (String sessionToken, String gameId) throws Java.GameSystem.LobbyTimeExpired
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/LobbyTimeExpired:1.0"))
                    throw Java.GameSystem.LobbyTimeExpiredHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public void submitWord (String sessionToken, String gameId, String word) throws Java.GameSystem.InvalidWord
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/InvalidWord:1.0"))
                    throw Java.GameSystem.InvalidWordHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
  ...
  public String[] viewPlayers (String name)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                String $result[] = Java.GameSystem.PlayerNameListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public boolean isServerConnected () throws Java.GameSystem.lossConnection
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                if (_id.equals ("IDL:TestingGrounds/GameSystem/lossConnection:1.0"))
                    throw Java.GameSystem.lossConnectionHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
