...
public class _CallbackInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements Java.GameSystem.CallbackInterface
{
  ...
  public void UpdateLobGUI (Java.GameSystem.PlayerInfo[] playerData, String gameToken)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("UpdateLobGUI", true);
                Java.GameSystem.PlayerInfoListHelper.write ($out, playerData);
  ...
  public void startGameGUI (Java.GameSystem.PlayerInfo[] playerData, char[] charArrayList)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("startGameGUI", true);
                Java.GameSystem.PlayerInfoListHelper.write ($out, playerData);
                Java.GameSystem.CharListHelper.write ($out, charArrayList);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void updatePlayerReadyStatus (Java.GameSystem.PlayerInfo[] playerData, boolean[] readyStatus)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updatePlayerReadyStatus", true);
                Java.GameSystem.PlayerInfoListHelper.write ($out, playerData);
                Java.GameSystem.ReadyStatusListHelper.write ($out, readyStatus);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void broadcastGuessedWord (Java.GameSystem.PlayerInfo[] playerData, String word, String username)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void displayRoundWinner (Java.GameSystem.PlayerInfo[] playerData, String winnerName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void displayOverallWinner (Java.GameSystem.PlayerInfo[] playerData, String winnerName)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public void updateLeaderBoardGUI (Java.GameSystem.Users[] playerData)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updateLeaderBoardGUI", true);
                Java.GameSystem.TopFiveUsersHelper.write ($out, playerData);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void updateGameSessions (Java.GameSystem.Lobbies[] sessions)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updateGameSessions", true);
                Java.GameSystem.GameSessionListHelper.write ($out, sessions);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
  ...
  public void updateAccountsList (Java.GameSystem.Users[] playerData)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
