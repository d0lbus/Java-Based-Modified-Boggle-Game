...
public abstract class CallbackInterfacePOA extends org.omg.PortableServer.Servant
 implements Java.GameSystem.CallbackInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("updateGameSessions", new java.lang.Integer (17));
    _methods.put ("updateAccountsList", new java.lang.Integer (18));
    _methods.put ("showHomeScreen", new java.lang.Integer (19));
    _methods.put ("broadcastDisconnection", new java.lang.Integer (20));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         Java.GameSystem.PlayerInfo playerData[] = Java.GameSystem.PlayerInfoListHelper.read (in);
       ...
       {
         Java.GameSystem.PlayerInfo playerData[] = Java.GameSystem.PlayerInfoListHelper.read (in);
         char charArrayList[] = Java.GameSystem.CharListHelper.read (in);
       ...
       {
         Java.GameSystem.PlayerInfo playerData[] = Java.GameSystem.PlayerInfoListHelper.read (in);
         boolean readyStatus[] = Java.GameSystem.ReadyStatusListHelper.read (in);
       ...
       case 8:  // TestingGrounds/GameSystem/CallbackInterface/displayOverallWinner
       {
         Java.GameSystem.PlayerInfo playerData[] = Java.GameSystem.PlayerInfoListHelper.read (in);
         String winnerName = in.read_string ();
         this.displayOverallWinner (playerData, winnerName);
         out = $rh.createReply();
         break;
       }
       ...
       {
         Java.GameSystem.Users playerData[] = Java.GameSystem.TopFiveUsersHelper.read (in);
       ...
       case 17:  // TestingGrounds/GameSystem/CallbackInterface/updateGameSessions
       {
         Java.GameSystem.Lobbies sessions[] = Java.GameSystem.GameSessionListHelper.read (in);
         this.updateGameSessions (sessions);
         out = $rh.createReply();
         break;
       }

       case 18:  // TestingGrounds/GameSystem/CallbackInterface/updateAccountsList
       {
         Java.GameSystem.Users playerData[] = Java.GameSystem.TopFiveUsersHelper.read (in);
         this.updateAccountsList (playerData);
         out = $rh.createReply();
         break;
       }

       case 19:  // TestingGrounds/GameSystem/CallbackInterface/showHomeScreen
       {
         this.showHomeScreen ();
         out = $rh.createReply();
         break;
       ...
       case 20:  // TestingGrounds/GameSystem/CallbackInterface/broadcastDisconnection
       {
         String username = in.read_string ();
         this.broadcastDisconnection (username);
         out = $rh.createReply();
         break;
       }
